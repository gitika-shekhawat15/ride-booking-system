...
export default function DriverBusy({ onRetry, selectedRide }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="text-center">
        <h2 className="text-base md:text-lg font-bold text-white">Drivers are busy</h2>
        <p className="text-xs text-white/50 mt-1">All nearby drivers are occupied — try again!</p>
      </div>
