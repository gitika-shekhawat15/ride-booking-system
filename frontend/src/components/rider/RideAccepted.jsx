...
export default function RideAccepted({ selectedRide, driverInfo }) {
  return (
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-xs md:text-sm text-white/60 mt-1">
            Your <span className="text-[#D6FF2F] font-semibold">{selectedRide}</span> is arriving in 2 min
          </p>
        </div>
        ...
        {/* OTP */}
        <div className="
          bg-[#D6FF2F] rounded-2xl p-4 text-center
        ">
          <p className="text-xs text-black/60">OTP for this ride</p>
